...
export const ExternalOgp = async (props: Props) => {
	...
	return (
		...
		>
			...
			>
				<div class="flex flex-col justify-between px-6 py-4 h-full w-full max-md:px-4 overflow-hidden">
				...
				<div class="h-full">
					<img
						src={ogp.image}
						class={
							"h-full w-fit rounded-r-lg max-w-[32vw] object-cover object-left"
						}
